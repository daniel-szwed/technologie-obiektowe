...
var studentWithId = provider.CreateOrUpdate(student);
// var lazyStudent = new LazyStudentPrototype(provider, studentWithId);
// var street = lazyStudent.Address.Street;
var students = provider.ReadAll<Student>();
var lazyStudentAutogenerated = new LazyStudent(provider, students.Skip(1).First());
var address = lazyStudentAutogenerated.Address;
var classes = lazyStudentAutogenerated.Classes;
